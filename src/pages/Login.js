...
const Login = () => {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      {/* Cabeçalho */}
      <div style={{ backgroundColor: '#FFD700', padding: '20px', textAlign: 'center' }}>
        <img src={logo} alt="Logo" style={{ height: '80px', marginRight: '15px', width: 90 }} />
      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexGrow: 1 }}>
        ...
        >
          ...
          {/* Botão de Entrar */}
          <Form.Item>
            <Button style={{ background: '#FFD700', color: 'black' }} type="primary" htmlType="submit" block>
              Entrar
            </Button>
          </Form.Item>
